...
import org.webpieces.example.mock.MockRemoteSystem;
...
public class TestLesson1BasicRequestResponse {
	...
	public void setUp() throws InterruptedException, ClassNotFoundException {
		...
		WebpiecesExampleServer webserver = new WebpiecesExampleServer(new PlatformOverridesForTest(), new AppOverridesModule(), new ServerConfig());
