...
public class AppRoutes implements Routes {
	...
	public void configure(DomainRouteBuilder domainRouteBldr) {
		...
		bldr.addRoute(BOTH, GET, "/main2",         "/org/webpieces/base/examples/ExamplesController.index", MAIN_ROUTE2);
		bldr.addRoute(BOTH, GET, "/main3",         "org.webpieces.base.examples.ExamplesController.index", MAIN_ROUTE3);
