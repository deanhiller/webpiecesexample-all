...
import org.webpieces.example.example.WebpiecesExampleRouteModule;
import org.webpieces.example.example.tags.TagLookupOverride;
...
public class WebpiecesExampleServer {
	...
	private byte[] fetchKey() {
		...
		String base64Key = "BFBPHc4b7uvyeRYvdeqKz7VKTgkuJQUP2DGwjNNCD/WHR3TmYCDVaxod20himW6tVIFkNfO1wnVNGjgWbOc9Ng==";  //This gets replaced with a unique key each generated project which you need to keep or replace with your own!!!
