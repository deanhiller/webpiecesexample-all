...
import org.webpieces.ExampleRouteId;
...
public class WebpiecesExampleRouteModule extends AbstractRouteModule {
	...
	public void configure(String currentPackage) {
		...
		addRoute(GET, "/absolute",      "/org/webpieces/WebpiecesExampleController.myMethod", WebpiecesExampleRouteId.ABSOLUTE);    //absolute path from root of classpath...
		addRoute(GET, "/absolute2",     "org.webpieces.WebpiecesExampleController.myMethod", WebpiecesExampleRouteId.ABSOLUTE2);    //we don't advise this as it is not consistent with relative paths but it can be done if you like
