...
public class WebpiecesExampleSSLFactory implements SSLEngineFactory {
	
	private String serverKeystore = "/keystore.jks";
	private	String password = "password";
	
	public WebpiecesExampleSSLFactory() {
		//since this bites a lot of people, let's read in the keystor early
		try(InputStream keySt = WebpiecesExampleSSLFactory.class.getResourceAsStream(serverKeystore)) {
			if(keySt == null)
